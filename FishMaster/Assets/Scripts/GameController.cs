...
public class GameController : MonoBehaviour
{
    ...
    public TMP_Text oneShootCostText;
    public TMP_Text goldText;
    public TMP_Text lvText;
    public TMP_Text lvNameText;
    public TMP_Text smallCountdownText;
    ...
    void UpdateUI()
    {
        ...
        while (exp >= 1000 + 200 * lv)
        {
            ...
            lvUpTips.transform.Find("Text").GetComponent<TMP_Text>().text = lv.ToString();
    ...
    void Fire()
    {
        ...
        if (Input.GetMouseButtonDown(0) && EventSystem.current.IsPointerOverGameObject() == false)
        {
            ...
            else
            {
                ...
                Ad ad = GameObject.FindObjectOfType<Ad>();
                ad.SetAdActive();
            }
        }
    }
